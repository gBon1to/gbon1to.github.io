...
As seen by the picture above the "find()" function was responsible for finding posts by their "id". Since in this function there was no input sanitization the only thing left to confirm the vulnerability was to analyze its calls. For this purposed I used "grep" once again.
